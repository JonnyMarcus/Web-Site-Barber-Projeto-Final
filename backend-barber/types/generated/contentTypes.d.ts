...
export interface ApiAgendamentoAgendamento extends Schema.CollectionType {
  ...
  attributes: {
    data: Attribute.Date;
    status: Attribute.Enumeration<['pendente', 'confirmado', 'cancelado']>;
    barbeiro: Attribute.Relation<
      'api::agendamento.agendamento',
      'oneToOne',
      'api::barbeiro.barbeiro'
    >;
    servico: Attribute.Relation<
      'api::agendamento.agendamento',
      'oneToOne',
      'api::servico.servico'
    >;
...
export interface ApiBarbeiroBarbeiro extends Schema.CollectionType {
