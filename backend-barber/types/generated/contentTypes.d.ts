...
export interface ApiAgendamentoAgendamento extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    barbeiro: Schema.Attribute.Relation<'oneToOne', 'api::barbeiro.barbeiro'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    data_horario: Schema.Attribute.DateTime;
...
export interface ApiBarbeiroBarbeiro extends Struct.CollectionTypeSchema {
  collectionName: 'barbeiros';
  info: {
    displayName: 'Barbeiro';
    pluralName: 'barbeiros';
    singularName: 'barbeiro';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    barbeiros: Schema.Attribute.Relation<'manyToMany', 'api::servico.servico'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    disponibilidade: Schema.Attribute.Text;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::barbeiro.barbeiro'
    > &
      Schema.Attribute.Private;
...
export interface ApiPlanoPlano extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::plano.plano'> &
      Schema.Attribute.Private;
    nome: Schema.Attribute.String;
    plano_mensal: Schema.Attribute.Decimal;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiServicoServico extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    descricao: Schema.Attribute.Text;
    duracao_minutos: Schema.Attribute.Integer;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::servico.servico'
    > &
      Schema.Attribute.Private;
    preco: Schema.Attribute.Float;
    publishedAt: Schema.Attribute.DateTime;
    servicos: Schema.Attribute.Relation<'manyToMany', 'api::barbeiro.barbeiro'>;
...
declare module '@strapi/strapi' {
  export namespace Public {
    export interface ContentTypeSchemas {
      ...
      'api::barbeiro.barbeiro': ApiBarbeiroBarbeiro;
